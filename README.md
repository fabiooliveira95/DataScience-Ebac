...
Este repositório contém os projetos e atividades desenvolvidas ao longo do curso de **Cientista de Dados** da [EBAC](https://ebaconline.com.br/), com foco em análise de dados, modelagem preditiva e uso prático de ferramentas do ecossistema Python.

## 🎯 Objetivo

Aplicar os conhecimentos aprendidos no curso em projetos práticos de Ciência de Dados, incluindo:
...
| Arquivo | Descrição |
|--------|-----------|
| `analise_exploratoria.ipynb` | Análise estatística e visual dos dados |
| `preprocessamento_dados.ipynb` | Limpeza e transformação dos dados |
| `modelo_regressao_linear.ipynb` | Construção e avaliação de modelo preditivo |
...
- NumPy fornece um grande conjunto de funções e operações de biblioteca que ajudam os programadores a executar facilmente cálculos numéricos. Modelos de Machine Learning, Processamento de Imagem e Computação Gráfica e Tarefas matemáticas.
...
Os pandas também podem excluir linhas que não são relevantes ou que contêm informações erradas, como valores vazios ou NULL. Isso é chamado de limpeza dos dados.
...
- Plotar gráficos interativos e dinâmicos.
...
- Seaborn é uma biblioteca de visualização de dados Python baseada em matplotlib. Ele fornece uma interface de alto nível para o desenho de gráficos estatísticos atraentes e informativos.
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/fabiooliveira95/DataScience-Ebac.git
...
5.Execute os notebooks com Jupyter:
